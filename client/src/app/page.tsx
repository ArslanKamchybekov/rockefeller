        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-semibold text-green-800">Rockefeller App</h1>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-green-700">Welcome, {user?.email}</span>
              <Button
                onClick={signOut}
                variant="outline"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="border-green-100">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg text-green-800">Getting Started</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="border-green-100">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg text-green-800">Next Steps</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-green-600 mb-3">
